...
void tmc2130_set_wave(uint8_t axis, uint8_t amp, uint16_t fac1000) {
    std::cout << "\n=== PRUSA C++ fac1000=" << fac1000 << " ===" << std::endl;
    ...
    do {
        ...
        if (b < 0) {
            std::cout << "Compression terminated: delta out of range at i=" << (int)i << ", dA=" << (int)dA << std::endl;
            break;
        }
        if (s > 3) {
            std::cout << "Compression terminated: segment out of range at i=" << (int)i << ", s=" << (int)s << std::endl;
            break;
        }
    ...
    std::cout << "Final i=" << (int)i << ", s=" << (int)s << std::endl;
}

int main() {
    std::cout << "PRUSA FIRMWARE C++ - ALL SUPPORTED FACTORS" << std::endl;
    std::cout << "==========================================" << std::endl;
    
    // Test fac 1.0 (fac1000 = 0)
    tmc2130_set_wave(0, 248, 0);
    
    // Test fac 1.1 (fac1000 = 100) 
    tmc2130_set_wave(0, 248, 100);
    
    // Test fac 1.2 (fac1000 = 200)
    tmc2130_set_wave(0, 248, 200);
