...
// Mock EEPROM and constants from Prusa firmware
...
// Mock TMC register write functions that print to console
...
// Exact copy of Prusa's tmc2130_calc_constant_torque_value function
...
// Exact copy of Prusa's tmc2130_set_wave function
...
int main() {
    std::cout << "PRUSA FIRMWARE C++ VERIFICATION" << std::endl;
    std::cout << "===============================" << std::endl;
