# This is a port of https://github.com/Clixster/Prusa-Firmware/tree/MK3_3.11.1 to 3.14.1

All changes done compared to Clixter repo are marked as PV for easy tracking. Only supports MK3s. Build instructions in CLX and Kuo were outdated so I cleaned those from readme. Now FW builds the same way as oficial Prusa FW, so you can follow official instructions. Functionally shall be identical. Below is a readme from Clixter, even below that original Kuo, and furtherst down the Prusa one.
